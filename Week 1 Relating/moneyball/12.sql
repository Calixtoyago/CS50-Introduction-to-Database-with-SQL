...
SELECT * FROM (
    ...
    WHERE "performances"."year" = 2001 AND ("salaries"."salary"/"performances"."H") IS NOT NULL
    GROUP BY "players"."id"
...
SELECT * FROM (
    ...
    JOIN "players" ON "salaries"."player_id" = "players"."id"
    JOIN "performances" ON "players"."id" = "performances"."player_id" AND "performances"."year" = "salaries"."year"
    WHERE "performances"."year" = 2001 AND ("salaries"."salary"/"performances"."RBI") IS NOT NULL
    GROUP BY "players"."id"
    ORDER BY ("salaries"."salary"/"performances"."RBI") ASC, "first_name" ASC, "last_name" ASC
    LIMIT 10
)
ORDER BY "last_name";
